...
import { fetchObjects } from "../redux/index";

function bucketDetails({ objectData, fetchObjects }) {
    ...
    useEffect(() => {
        fetchObjects(bucketid)
    }, [])

    console.log("objects", objectData);
...
<div className="customFont">
    ...
    <div className="grid-container">
        <div className="grid-item item1">All Files ({ objectData.data.objects ? objectData.data.objects.length: 0})</div>
        ...
        <div className="grid-item item3">
            <table className="grid-table">
                <tbody>
                    ...
                    {objectData && objectData.data.objects && objectData.data.objects.map(object => (
    ...
    <div className="grid-container">
        <div className="grid-item item1">
            ...
            <div> Storage : {objectData.data.objects.reduce((pv, cv) => pv + cv.size, 0)}</div>
        </div>
        <div className="grid-item item2">
            <button onClick={deleteBuc}>Delete Bucket</button>
        </div>
    </div>
    )}
